        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvataImageProduct = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OderStatusId = table.Column<int>(type: "int", nullable: false),
                    OrderStatusOderStatusId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_OrderStatuses_OrderStatusOderStatusId",
                        column: x => x.OrderStatusOderStatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_OrderStatusOderStatusId",
                table: "Orders",
                column: "OrderStatusOderStatusId");
